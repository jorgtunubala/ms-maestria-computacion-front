...
export class RespuestaComiteRecoCredPasantia implements DocumentoPDFStrategy {
    ...
    generarDocumento(marcaDeAgua: boolean): jsPDF {
        ...
        const cuerpo = `Reciba un cordial saludo. Me dirijo a usted para informar que en la sesión del ${dia} de ${mesEnLetras} de ${año}, el Comité de Programa revisó su solicitud con radicado ${radicado}, referente al reconocimiento de créditos por pasantía de investigación, decidiendo no avalar la solicitud. A continuación se expone el concepto:`;
...
export class RespuestaConcejoRecoCredPasantia implements DocumentoPDFStrategy {
    ...
    generarDocumento(marcaDeAgua: boolean): jsPDF {
        ...
        const txtAsunto = `Asunto: Respuesta a Solicitud ${radicado} de reconocimiento de créditos por pasantía de investigación\n`;
        const txtCuerpo = `Reciba un cordial saludo. Por medio de la presente, me dirijo a usted para informarle que el día ${
            fechaConcejo[0]
        } de ${mesEnLetras} de ${
            fechaConcejo[2]
        } se recibió respuesta del Consejo de Facultad referente a su solicitud ${radicado} de reconocimiento de créditos por pasantía de investigación. ${
