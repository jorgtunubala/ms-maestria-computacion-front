...
import { backend } from 'src/app/core/constants/api-url'; // Ajusta según tu ruta del backend
...
export class EstadisticaEvaluacionService {
  ...
  getEstadisticasEvaluacion(idEvaluacion: number): Observable<any> {
    return this.http.get<any>(`${backend('evaluacion/estadistica/?id_evaluacion=')}${idEvaluacion}`, {
      headers: getHeaders(),
    });
  }
  ...
  getAsignaturasEvaluacion(idEvaluacion: number): Observable<any> {
    return this.http.get<any>(`${backend('evaluacion/asignatura/?id_evaluacion=')}${idEvaluacion}`, {
      headers: getHeaders(),
    });
  }
  ...
  getDocentesPorAsignatura(idEvaluacion: number, idAsignatura: number): Observable<any> {
    return this.http.get<any>(`${backend('evaluacion/asignatura/docente/?id_evaluacion=')}${idEvaluacion}&id_asignatura=${idAsignatura}`, {
      headers: getHeaders(),
    });
  }
  ...
  getEstadisticasDocente(idEvaluacion: number, idAsignatura: number, idDocente: number): Observable<any> {
    return this.http.get<any>(`${backend('evaluacion/estadistica/docente/?id_evaluacion=')}${idEvaluacion}&id_asignatura=${idAsignatura}&id_docente=${idDocente}`, {
      headers: getHeaders(),
    });
  }
  ...
  generarReporte(idEvaluacion: number): Observable<Blob> {
    return this.http.get<Blob>(`${backend('evaluacion/estadistica/resportes/?id_evaluacion=')}${idEvaluacion}`, {
      headers: getHeaders(),
